...
pub mod test_fixtures {
    ...
    pub use crate::spec_kat::mainnet::{
        SPEC_GLOAS_AGGREGATE_AND_PROOF_ROOT as SPEC_GLOAS_AGGREGATE_AND_PROOF_ROOT_MAINNET,
        SPEC_GLOAS_AGGREGATE_AND_PROOF_SSZ as SPEC_GLOAS_AGGREGATE_AND_PROOF_SSZ_MAINNET,
    };
    pub use crate::spec_kat::minimal::{
        SPEC_GLOAS_AGGREGATE_AND_PROOF_ROOT, SPEC_GLOAS_AGGREGATE_AND_PROOF_SSZ,
        ...
        SPEC_GLOAS_EXECUTION_PAYLOAD_ENVELOPE_ROOT, SPEC_GLOAS_EXECUTION_PAYLOAD_ENVELOPE_SSZ,
    };
}
